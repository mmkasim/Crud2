        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li>
                        <a href="../../../assets/index.html"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span>
                    ...
                    <li>
                        <a href="./lista.php"><i class="fa fa-diamond"></i> <span class="nav-label">Categorias</span></a>
                    </li>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header">
                        <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="../../../assets/#"><i class="fa fa-bars"></i> </a>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                ...
                                <a href="./form.php" class="btn btn-info btn-sm pull-right" type="button"><i class="fa fa-plus"></i><strong> Nova</strong>
                                </a>
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($categorias as $categoria) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="./form.php?id=<?php echo $categoria->getId(); ?>" class="btn btn-info btn-sm m-r-sm" type="button"><i class="fa fa-paste"></i>
                                                        Editar</a>
                                                    <a href="../../Controller/Categoria.php?del=<?php echo $categoria->getId(); ?>" class="btn btn-danger btn-sm" type="button"><i class="fa fa-close"></i>
                                                        Excluir</a>
